...
class TransferFunctions:
    def sigmoid(x, Derivative=False):
        if not Derivative:
            ...
            out = TransferFunctions.sigmoid(x)
            return out * (1.0 - out)
...
# Classes
#
class BackPropagationNetwork(SignalProcessing):
...
if __name__ == "__main__":
    ...
    # sg = SignalProcessing()
    # lvInput= sg.GetFinal().ravel()
    # lvTarget = np.array([0.80])
    #
    # print(lvInput)
    # print(lvInput.shape)
    #
    ...
    # lFuncs = [None, TransferFunctions.sigmoid, TransferFunctions.linear]
    #
    # bpn = BackPropagationNetwork((1, 2, 1), lFuncs)
    #
    # lnMax = 100000
    # lnErr = 1e-6
